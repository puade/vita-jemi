  ...
  if (recipientName) {
    ...
    // Countdown function
    function countdown() {
      const countDate = new Date("April 04, 2026 09:30:00").getTime();
...
function fetchUcapan() {
  var url = 'https://script.google.com/macros/s/AKfycbzJn6QlwhdWQ8paFvjdjTzbu0TYwvf1Q_8IwMgSYoGlsTdhro-_EGgnOMwEpobkUrUhTw/exec'; // Ganti dengan URL Web App Google Apps Script Anda
...
document.getElementById('formPernikahan').addEventListener('submit', function(event) {
  ...
  fetch('https://script.google.com/macros/s/AKfycbzJn6QlwhdWQ8paFvjdjTzbu0TYwvf1Q_8IwMgSYoGlsTdhro-_EGgnOMwEpobkUrUhTw/exec', {
    method: 'POST',
